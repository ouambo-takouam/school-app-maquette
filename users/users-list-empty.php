...
<html lang="en">
  <head>
    ...
    <title>Projet scolaire - Liste utilisateurs (vide)</title>
    <!-- CSS TYLES -->
    ...
    <main>
      ...
      <div class="content">
        <section class="empty-list">
          ...
          <p>Aucun utilisateur ajoute pour le moment</p>
          <button class="btn primary">ajouter nouveau utlisateur</button>
        </section>
      </div>
    </main>
