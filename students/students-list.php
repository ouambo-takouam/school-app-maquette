  ...
  <body>
      ...
      <header>
        ...
        <div class="header__navigation m-r-30 border-b">
          <div class="header__wrapper">
            <h1 class="header__title">Élèves</h1>
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content box">
        <header>
          <span>Désactiver #TENHO Albert</span>
          <span class="close">&times;</span>
        </header>
        <p>Etes-vous sûr de vouloir désactiver l'eleve TENHO Albert ? Il n'apparaitra plus dans la liste des eleves.</p>
        <div class="btns">
